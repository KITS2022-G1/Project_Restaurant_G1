            ...
            <div class="container-fluid" style={{ backgroundColor: '#fff', height: 'auto' }}>
                ...
                <div className="row mb-3">
                    <div className="col-md-6">
                        <div class="container">
                            <img src={Meeting} className="rounded-circle rounded mx-auto d-block p-5 img-fluid" style={{ width: '60%', height: undefined, aspectRatio: 1 / 1, objectFit: "cover" }}></img>
                        </div>
                        <p style={{ fontWeight: "bold", fontSize: "32px" }} className="text-center "> HỌP & SỰ KIỆN </p>
                        <p style={{ fontSize: "24px", justifyContent: "left" }} className="text-center titleHome">Ngoài không gian sang trọng để phù hợp với mọi cuộc tụ họp,
                            ...
                            Để có một kế hoạch tỉ mỉ và đảm bảo kết thúc thành công, chúng tôi ở đây vì bạn.</p>
                    ...
                    <div className="col-md-6">
                        <div class="container">
                            <img src={Banqueting} className="rounded-circle rounded mx-auto d-block p-5 img-fluid" style={{ width: '60%', height: undefined, aspectRatio: 1 / 1, objectFit: "cover" }}></img>
                        </div>
                        <p style={{ fontWeight: "bold", fontSize: "32px" }} className="text-center "> CƠ SỞ </p>
                        <p style={{ fontSize: "24px", justifyContent: "left" }} className="text-center titleHome"> Phòng khiêu vũ 200m2 của chúng tôi được thiết kế để phù hợp với cả những sự kiện thanh lịch nhất.
                            Bạn cũng sẽ thấy rằng nó được trang bị với công nghệ hiện đại,
                            có thể đáp ứng bất kỳ nhu cầu nào của bạn. Nó cũng có thể được chia thành 2 hoặc 3 không gian nhỏ hơn,
                            để phù hợp hơn với các chi tiết cụ thể của bạn. Một tùy chọn của Buffet đơn giản hoặc Menu Gourmet có sẵn một cách thuận tiện cho bạn.</p>
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <button type="button" class="btn btn-outline-warning" style={{ fontSize: "24px" }}>Xem tiếp</button>
                        </div>
                    </div>
